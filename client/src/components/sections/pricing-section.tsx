...
export default async function PricingSection() {
  ...
  return (
    <div className="py-24 sm:py-32 px-4 md:px-0" id="pricing">
      <div className="mx-auto max-w-7xl md:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl flex flex-col justify-center items-center sm:text-center">
          <h1 className="text-2xl text-center font-semibold sm:text-3xl xl:text-[40px] relative text-gray-900 dark:text-white">
            ...
            <svg
              ...
              className="hidden md:absolute -bottom-7 right-0"
            >
              <path
        ...
        {/* PRO pricing card */}
        <div className="bg-white w-full dark:bg-gray-950 mt-16 rounded-3xl ring-1 ring-gray-200 dark:ring-gray-800 sm:mt-20 lg:mx -0 lg:flex">
          <div className="p-8 sm:p-10 lg:flex-auto">
            <h3 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              {plans.pro.name}
            </h3>
            <p className="mt-6 text-base leading-7 text-gray-600 dark:text-gray-300">
              Create AI powered sharable chats for your documentation
            </p>
